...
#define GPIO_MODE_Analog         ((uint8_t)0x00U)
#define GPIO_MODE_INPUT_Floating ((uint8_t)0x01U)
#define GPIO_MODE_INPUT_PU       ((uint8_t)0x02U)
#define GPIO_MODE_INPUT_PD       ((uint8_t)0x03U)
#define GPIO_MODE_OUTPUT_PP      ((uint8_t)0x04U)
#define GPIO_MODE_OUTPUT_OD      ((uint8_t)0x05U)
#define GPIO_MODE_OUTPUT_AF_PP   ((uint8_t)0x06U)
#define GPIO_MODE_OUTPUT_AF_OD   ((uint8_t)0x07U)
#define GPIO_MODE_INPUT_AF_OD    ((uint8_t)0x08U)

//===========@ref GPIO_SPEED_define
//1: Output mode, max speed 10 MHz.
//2: Output mode, max speed 2 MHz.
//3: Output mode, max speed 50 MHz
#define GPIO_OUTPUT_SPEED_10M    ((uint8_t)0x01U)
#define GPIO_OUTPUT_SPEED_2M     ((uint8_t)0x02U)
#define GPIO_OUTPUT_SPEED_50M    ((uint8_t)0x03U)
